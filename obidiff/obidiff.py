...
class ControlLDM(LatentDiffusion):
    ...
    def apply_model(self, x_noisy, t, cond, *args, **kwargs):
        ...
        if cond['c_concat'] is None:
            ...
            control = self.control_model(x=x_noisy, hint=torch.cat(
                cond['c_concat'], 1), timesteps=t, context=cond_txt)
            control = [c * scale for c,
                       scale in zip(control, self.control_scales)]
            eps = diffusion_model(x=x_noisy, timesteps=t, context=cond_txt,
    ...
    def log_images(self, batch, N=4, n_row=2, sample=False, ddim_steps=50, ddim_eta=0.0, return_keys=None,
        ...
        log["glyph"] = c_cat * 2.0 - 1.0
        log["style"] = c / 127.5 - 1.0
